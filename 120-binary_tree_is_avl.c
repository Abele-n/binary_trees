...
/**
 * bal_avl - the auxiliary function to compare each AVL subtree.
 * @tree: nodes that point to the tree to check.
 * @high: node that point to the higher node selected
 * @lower: nodes that point to the selected lower node.
...
/**
 * binary_tree_is_avl - used to check if a binary tree is a valid AVL tree.
